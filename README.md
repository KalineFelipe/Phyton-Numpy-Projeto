# Projeto limgaugem Python e NumPy
...
**Disciplina/Curso:** (Introdução aos Softwares Estatísticos)  
...
Dessa forma, iremos demostrar o uso combinado de estruturas básicas da linguagem Python e
funcionalidades do NumPy. Por meio de exemplos práticos nos submódulo solicitado (numpy.linalg e numpy.random) no qual estão implementados no arquivo `main.py`.